...
export const Whisky = withRouter(( props:WhiskyProps ) => {
    console.log(props);
    const { history } = props;
        ...
        <div className={`${classes.root} ${classes.column}`}>
            ...
            <AppBar position="fixed" className={clsx(classes.appBar, {[classes.appBarShift]: open })}> 
                <Toolbar className={classes.toolbar}>
                    ...
                    <Button className={classes.toolbar_button} onClick={handleDialogClickOpen}>Add New Whisky</Button>

                    
                    <Dialog open={dialogOpen} onClose={handleDialogClickClose} aria-labelledby="form-dialog-title">
                        <DialogTitle id="form-dialog-title">Add New Whisky</DialogTitle>
                        <DialogContent>
